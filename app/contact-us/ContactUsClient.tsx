            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+34952757255" className="text-emerald-600 hover:text-emerald-700 transition-colors">
                    +34 952 757 255
                  </a>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@c-k.es" className="text-emerald-600 hover:text-emerald-700 transition-colors">
                    info@c-k.es
                  </a>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Monday to Friday / 9:00 to 15:00</p>
                </div>
              </div>
            </div>
          </div>
