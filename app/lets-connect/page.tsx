    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <section className="bg-gradient-to-br from-emerald-600 to-emerald-800 text-white py-20">
        <div className="max-w-[96rem] mx-auto px-8">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 text-balance">Let's Connect</h1>
          <p className="text-xl md:text-2xl text-emerald-50 max-w-3xl text-balance">
            Ready to transform your agricultural practices? Get in touch with our team to discuss how CK® can help you
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  We're here to answer your questions and provide the support you need. Reach out to us through any of
                  the channels below.
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200 space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 font-medium">Monday to Friday / 9:00 to 15:00</p>
                  </div>
                </div>
              </div>
            </div>
