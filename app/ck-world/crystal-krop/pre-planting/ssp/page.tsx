        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-xl shadow-sm border p-8 space-y-6">
              <h1 className="text-3xl font-bold text-foreground">CK® Crystal Krop™ SSP</h1>

              <div className="bg-emerald-50 border-l-4 border-emerald-600 p-6 rounded">
                <p className="text-gray-700 leading-relaxed">
                  <strong>CK® Crystal Krop™ SSP</strong> is a high-quality solid Single Superphosphate fertilizer
                  formulated for soil application. With phosphorus pentoxide (P₂O₅) highly soluble in mineral acids and
                  water, calcium oxide (CaO) to support soil structure, and sulfur trioxide (SO₃) to enhance protein
                  synthesis and enzymatic activity, it provides a complete foundation for robust crop growth. The
                  formulation can be supplied in powdery form for rapid dissolution or processed into uniform granules
                  for precision soil application, making it versatile across different crop management systems.
                </p>
              </div>
