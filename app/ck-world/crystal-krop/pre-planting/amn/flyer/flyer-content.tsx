...
export default function AMNFlyerContent() {
  const handleDownload = () => {
    const link = document.createElement('a')
    link.href = '/images/amn-flyer.jpeg'
    link.download = 'CK-Crystal-Krop-AMN-Flyer.jpeg'
      ...
      <main className="container py-8 md:py-12">
        <div className="max-w-5xl mx-auto">
          <div className="mb-6 text-center">
            <h1 className="text-3xl font-bold text-foreground mb-2">CK® Crystal Krop™ AMN Product Flyer</h1>
            <p className="text-muted-foreground">Granular Nitrogen Fertilizer for Rapid and Sustained Crop Growth</p>
          </div>
