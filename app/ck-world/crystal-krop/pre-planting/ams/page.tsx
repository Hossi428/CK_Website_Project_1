        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-xl shadow-sm border p-8 space-y-6">
              <h1 className="text-3xl font-bold text-foreground">CK® Crystal Krop™ AMS</h1>

              <div className="bg-emerald-50 border-l-4 border-emerald-600 p-6 rounded">
                <p className="text-gray-700 leading-relaxed">
                  <strong>CK® Crystal Krop™ AMS</strong> is a high-purity crystalline ammonium sulfate formulated for
                  fertigation and soil application. Delivering nitrogen entirely in the ammoniacal form together with
                  readily available sulfate sulfur (SO₃ equivalent), it supports vigorous early growth, protein
                  synthesis, and efficient chlorophyll formation. Its high solubility and gentle acidifying effect help
                  improve nutrient availability in neutral-alkaline soils and maintain clean irrigation systems.
                </p>
              </div>
